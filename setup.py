"""setup.py - install script for pandoc-tpp."""
...
LONG_DESCRIPTION = """A pandoc template preprocessor."""
...
setup(
    ...
    description='A pandoc template preprocessor.',
    long_description=LONG_DESCRIPTION,
    license='GPL',
    keywords='pandoc template preprocessor',
    url='https://github.com/tomduck/pandoc-tpp',
    download_url='https://github.com/tomduck/pandoc-tpp/tarball/'+VERSION,

    py_modules=['pandoc_tpp'],
    entry_points={'console_scripts':['pandoc-tpp = pandoc_tpp:main']},
    cmdclass=cmdclass,
